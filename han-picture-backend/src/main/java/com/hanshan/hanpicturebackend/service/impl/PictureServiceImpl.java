package com.hanshan.hanpicturebackend.service.impl;
...
import com.hanshan.hanpicturebackend.manager.FileManager;
import com.hanshan.hanpicturebackend.mapper.PictureMapper;
    ...
    public PictureVO uploadPicture(MultipartFile multipartFile,
        ...
        if (pictureId != null) {
            boolean exists = this.lambdaQuery()
                    ...
                    .exists();
            ThrowUtils.throwIf(!exists, ErrorCode.NOT_FOUND_ERROR, "更新失败，图片不存在");
        }
        // 按照用户 id 划分目录
